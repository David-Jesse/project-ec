        ...
        <div className='col-span-2 bg-white rounded-lg shadow-md p-6'>
          ...
          {currentStep === 1 && (
            ...
            >
              ...
              <p className='text-gray-600'>All transactions are secure and encryted</p>
                ...
                <div className='flex justify-between pt-4'>
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-md shadow-sm text-sm font-medium text-white bg-amber-600 ${
                      loading || !stripe
                      ? 'opacity-70 cursor-not-allowed' : 'bg:hover-amber-800 focus:outline-none focus:ring-2 focus:ring-offest-2 focus:ring-amber-500'
                    }`}
                  >
                      {loading ? (
